...
public class NodeRuleFixedLength extends AbstractNodeRule {

    private JbNodeDefImpl.Initializator<Integer, Integer> init;

    public NodeRuleFixedLength(final Integer l) {
        super(l);
    }
    ...
    protected void setup() {
        ...
        init = new JbNodeDefImpl.InitializatorFixedLength<Integer, Integer>();
